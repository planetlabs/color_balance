...
class Tests(unittest.TestCase):
    ...
    def test_create_mask(self):
        ...
        test_mask = colorimage.create_mask(test_band)
        ...
        # to 3 masked
        test_mask = colorimage.create_mask(test_band, value=3)
        ...
        test_mask = colorimage.create_mask(test_band, value=6)
        expected_mask = numpy.array([[255, 255], [255, 255]],
            dtype=numpy.uint8)
        numpy.testing.assert_array_equal(test_mask, expected_mask)
    ...
    def test_combine_masks(self):
        ...
        test_mask = colorimage.combine_masks([mask1, mask2])
    ...
    def test_map_masked(self):
        ...
        masked_band = colorimage.map_masked(test_band, test_mask, value=7)
        ...
        masked_band = colorimage.map_masked(test_band, test_mask)
        numpy.testing.assert_array_equal(masked_band, expected_band)
    ...
    def test_get_mask_percent(self):
        ...
        expected = 100
        test_percent = colorimage.get_mask_percent(test_mask)
